...
class InvoiceHistoryTab(QWidget):
    ...
    def _build_ui(self):
        ...
        from PyQt6.QtWidgets import QDateEdit, QLineEdit, QComboBox
        ...
        # Table - Add an actions column at the end
        ...
        self.table.setColumnWidth(actions_col, 240)  # Increased width for better visibility
